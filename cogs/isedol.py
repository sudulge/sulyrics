        ...
        embed = {"embeds": [
            {
                ...
                "fields": [
                    {
                        "name": "우왁굳",
                        "value": list[0] if list[0] else "offline",
                        "inline": False
                    },
                    {
                        "name": "아이네",
                        "value": list[1] if list[1] else "offline",
                        "inline": True
                    },
                    {
                        "name": "징버거",
                        "value": list[2] if list[2] else "offline",
                        "inline": True
                    },
                    {
                        "name": "릴파",
                        "value": list[3] if list[3] else "offline",
                        "inline": True
                    },
                    {
                        "name": "주르르",
                        "value": list[4] if list[4] else "offline",
                        "inline": True
                    },
                    {
                        "name": "고세구",
                        "value": list[5] if list[5] else "offline",
                        "inline": True
                    },
                    {
                        "name": "비챤",
                        "value": list[6] if list[6] else "offline",
                        "inline": True
                    },                   
                ],
                "image" : {"url": "https://cdn.discordapp.com/attachments/1033149773504593921/1060293166114287676/isedol.jpg"},
            }
        ]}
